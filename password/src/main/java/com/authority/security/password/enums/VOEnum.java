package com.authority.security.password.enums;
...
public enum  VOEnum {
    ...
    USER_PASSWORD_ERROR(1001,"USER PASSWORD ERRRO","账号或者密码错误");


    private int code;
    private String englishMessage;
    private String chinaMessage;

    VOEnum(int code, String englishMessage, String chinaMessage) {
        this.code = code;
        this.englishMessage = englishMessage;
        this.chinaMessage = chinaMessage;
    }
}
